    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View view1 = LayoutInflater.from(Monday.this)
                ...
                if (!spinner_subject.isEmpty()) {
                    ...
                    adapter = new ArrayAdapter<String>(Monday.this,
                            android.R.layout.simple_spinner_dropdown_item, spinner_subject);

                    class_spinner.setAdapter(adapter);

                    AlertDialog.Builder builder = new AlertDialog.Builder(Monday.this)
                            ...
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if(Integer.parseInt(starthour.getText().toString())<21&&
                                        ...
                                        long Id = DatabaseHelper.addRecord_Monday(
                                        ...
                                        Toast.makeText(Monday.this, "Invalid Time",
                                                Toast.LENGTH_LONG).show();
                     ...
                     */
                    Toast.makeText(Monday.this, "Please Add Subject Detail First",
                            Toast.LENGTH_LONG).show();
                }
                    ...
                    .setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    DatabaseHelper.contextset(getApplicationContext()).deleteNote_Monday(note.Id);
