    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View view1 = LayoutInflater.from(Friday.this)
                ...
                if (!spinner_subject.isEmpty()) {
                    ...
                    adapter = new ArrayAdapter<String>(Friday.this,
                            android.R.layout.simple_spinner_dropdown_item, spinner_subject);

                    class_spinner.setAdapter(adapter);

                    AlertDialog.Builder builder = new AlertDialog.Builder(Friday.this)
                            ...
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if(Integer.parseInt(starthour.getText().toString())<21&&
                                        ...
                                        long Id = DatabaseHelper.addRecord_Friday(
                                        ...
                                        Toast.makeText(Friday.this, "Invalid Time",
                                                Toast.LENGTH_LONG).show();
                     ...
                     */
                    Toast.makeText(Friday.this, "Please Add Subject Detail First",
                            Toast.LENGTH_LONG).show();
                }
                    ...
                    .setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,
                                    ...
                                    DatabaseHelper.contextset(getApplicationContext()).deleteNote_Friday(note.Id);
